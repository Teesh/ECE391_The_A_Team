...
extern void * ece391_malloc (uint32_t n_bytes);
extern void ece391_pmap (void);
extern void ece391_free (void* ptr);
extern void ece391_clock (uint32_t sec);
extern uint32_t ece391_pac (void * pacman_in, int32_t flag);
extern char ece391_rx ();
extern void ece391_tx (uint8_t c);
